...
export function mapGameStateForView(realGameState) {
  ...
  return {
    game_name: realGameState.game_name ?? (realGameState.gameId === 'among-us' ? 'Undercover' : realGameState.gameId === 'texas-holdem' ? 'Texas Hold\'em' : 'Neon Heist'),
    ...
    winner_hand: realGameState.winner_hand,
